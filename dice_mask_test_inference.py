...
def inference(ood_dir, uncertainty_metric):
    ...
    fold_paths = [
        f"/home/bmep/plalfken/my-scratch/trained_models/model_fold0_{uncertainty_metric}.pt.gz",
        f"/home/bmep/plalfken/my-scratch/trained_models/model_fold1_{uncertainty_metric}.pt.gz",
        f"/home/bmep/plalfken/my-scratch/trained_models/model_fold2_{uncertainty_metric}.pt.gz",
        f"/home/bmep/plalfken/my-scratch/trained_models/model_fold3_{uncertainty_metric}.pt.gz",
        f"/home/bmep/plalfken/my-scratch/trained_models/model_fold4_{uncertainty_metric}.pt.gz",
